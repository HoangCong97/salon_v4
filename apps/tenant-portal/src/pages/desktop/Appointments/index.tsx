...
import { ViewMode, AppointmentStatus } from "./types";
    ...
    <div className={styles.container}>
      ...
      <div className={styles.rowHeaderLayout}>
        ...
        <div className={styles.leftPageHeader}>
          <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
            ...
            <div>
              ...
              <p className={styles.headerSub}>
                Quản lý lịch hẹn · Kéo thả để xếp lịch
              </p>
            </div>
          </div>
          ...
          <div className={styles.viewModeSelector}>
            {(
              [
                {
                  mode: "by-staff" as ViewMode,
                  icon: Users,
                  label: "Theo nhân viên",
                },
                {
                  mode: "by-customer" as ViewMode,
                  icon: User,
          ...
          <div className={styles.statusActionGroup}>
            ...
            <div className={styles.statusBadgesContainer}>
              {(
                ["PENDING", "CONFIRMED", "IN_PROGRESS"] as AppointmentStatus[]
              ).map((s) => {
        ...
        <div className={styles.rightCustomerTabsHeader}>
          <div className={styles.waitingListLabel}>DANH SÁCH KHÁCH CHỜ</div>
          <div className={styles.waitingListScrollable}>
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (sidebarScrollRef.current)
                      sidebarScrollRef.current.scrollTop = Math.max(
                        0,
                        targetScrollTop,
                      );
                  }}
            ...
            {customerList.length === 0 && (
              <div className={styles.emptyWaitingText}>Chưa có lịch hẹn</div>
            )}
          </div>
        </div>
      </div>
      ...
      <div className={styles.rowLegendLayout}>
          ...
          {viewMode === "by-staff" ? (
            <>
              ...
              {customerCols.slice(0, 8).map((c) => {
                const cc =
                  customerColorsMap.get(c.id)?.accentColor ?? hashColor(c.name);
                return (
            ...
            <>
              ...
              {staffList
                .filter((s) => todayItems.some((i) => i.staffId === s.id))
                .map((s) => (
        ...
        <div className={styles.rightCustomerInfo}>
          {selCust ? (
            ...
            >
              <div className={styles.customerNameInfo}>{selCust.name}</div>
              {selCust.phone && (
                        ...
                        <div className={styles.staffHeaderSub}>
                          {
                            todayItems.filter(
                              (i) =>
                                i.staffId === s.id && i.status !== "CANCELLED",
                            ).length
                          }{" "}
                          DV
                        </div>
            ...
            <div className={styles.gridBody}>
              ...
              <div className={styles.timeGutter}>
                {timeSlots.map((slot) => (
                  ...
                  >
                    {slot % 4 === 0 && (
                      <span className={styles.timeGutterLabel}>
                        {slotToTime(slot)}
                      </span>
                    )}
                  </div>
                ...
                return (
                  <div
                    ...
                    onDrop={(e) => {
                      ...
                      if (slot >= 0 && slot < TOTAL_SLOTS) {
                        ...
                        const slotsNeeded = draggedItem
                          ? durationSlots(draggedItem.service.duration)
                          : 1;
                        const blocked = isSlotRangeBlocked(
                          colId,
                          slot,
                          slotsNeeded,
                          dragState?.id ?? "",
                  ...
                  >
                    ...
                    {timeSlots.map((slot) => {
                      ...
                      if (dragState && dragOverKey) {
                        ...
                        if (
                          overColId === colId &&
                          slot >= overSlot &&
                          slot < overSlot + slotsNeeded
                        ) {
                          isHighlightedTarget = true;
                          highlightBlocked = isSlotRangeBlocked(
                            colId,
                            overSlot,
                            slotsNeeded,
                            dragState.id,
                    ...
                    {colItems.map((item) => {
                      ...
                      const height =
                        durationSlots(item.service.duration) * SLOT_HEIGHT - 6;
                      ...
                      return (
                        <GridServiceCard
                          ...
                          onDragStart={(e) =>
                            handleDragStart(e, item.id, "grid")
                          }
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      pointerEvents:
                        dragState && !isBeingDragged ? "none" : "auto",
                    }}
                  >
                    {height < 40 ? (
        ...
        >
          <div style={{ display: "flex", gap: 8 }}>
            ...
            >
              ...
              <span style={{ fontSize: 10, fontWeight: 600, color: "#c2410c" }}>
                Tại quầy
              </span>
            </div>
          </div>
