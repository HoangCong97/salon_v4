    ...
    <div className={styles.turnsContainer}>
      ...
      <div className={styles.turnsHeaderRow}>
        <div className={styles.turnsHeaderLeft}>
          <span className={styles.turnsTitleDesc}>
            Lịch xếp khách xoay tua hôm nay tại:{" "}
        ...
        <div className={styles.turnsHeaderActions}>
          <button
            ...
            onClick={handleOpenAddStaffToQueue}
          >
      ...
      {loading ? (
        ...
        <div className={`card ${styles.turnsEmptyCard}`}>
          ...
          <p className={styles.turnsEmptyDesc}>
            Hôm nay không có nhân viên nào có lịch trực ca hoạt động tại chi
            nhánh này.
          </p>
          <button
          ...
          <div className={`data-table-container ${styles.turnsTableContainer}`}>
            <table className="data-table">
              <thead>
                <tr>
                  <th
                    className={styles.turnsTh}
                    style={{ width: "100px", textAlign: "center" }}
                  >
                    Số TT
                  </th>
                  <th className={styles.turnsTh} style={{ width: "240px" }}>
                    Tên thợ
                  </th>
                  <th className={styles.turnsTh} style={{ width: "140px" }}>
                    Chức danh
                  </th>
                  <th
                    className={styles.turnsTh}
                  ...
                  <th className={styles.turnsTh} style={{ width: "200px" }}>
                    Lần gán khách cuối
                  </th>
                  <th
                    className={styles.turnsTh}
                ...
                {dailyTurns.map((turn, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td
                        className={styles.turnsTdCenter}
                      ...
                      <td className={styles.turnsTdNoPadding}>
                        <ExcelInput
                          ...
                          onChange={(val) =>
                            handleInlineTurnChange(turn.staffId, "walkin", val)
                          }
                          onBlur={() =>
                            handleAutoSaveTurn(turn.staffId, "walkin")
                          }
                          textAlign="center"
                          fontWeight="600"
                        />
                      ...
                      <td className={styles.turnsTdNoPadding}>
                        <ExcelInput
                          ...
                          onChange={(val) =>
                            handleInlineTurnChange(turn.staffId, "booked", val)
                          }
                          onBlur={() =>
                            handleAutoSaveTurn(turn.staffId, "booked")
                          }
                          textAlign="center"
                          fontWeight="600"
                        />
                      ...
                      >
                        <div className={styles.turnsActionsWrapper}>
                          <button
                            ...
                            onClick={() =>
                              handleAssignTurn(turn.staffId, "walkin")
                            }
                          ...
                          <button
                            ...
                            onClick={() =>
                              handleAssignTurn(turn.staffId, "booked")
                            }
      ...
      >
        ...
        <div>
          ...
          >
            <li>
              Thợ có số lượt làm khách Walk-in ít nhất trong ngày được ưu tiên
              đứng lên đầu hàng đợi.
            </li>
            <li>
              Trong trường hợp số lượt bằng nhau, thợ có thời gian gán khách lâu
              hơn (hoặc chưa làm khách nào) sẽ được xếp lên trước.
            </li>
            <li>
              Khi một thợ được bấm <strong>Nhận khách Walk-in</strong>, hệ thống
              tự động tăng lượt Walk-in của thợ đó và đẩy họ xuống vị trí cuối
              hàng đợi một cách công bằng.
            </li>
            <li>
              Khi thợ được gán khách đặt lịch có chỉ định đích danh (Booked),
              bấm **Đặt trước (Chỉ định)** để cộng lượt chỉ định mà không làm
              thay đổi thứ tự xếp hàng Walk-in.
            </li>
          </ol>
        </div>
      </div>
