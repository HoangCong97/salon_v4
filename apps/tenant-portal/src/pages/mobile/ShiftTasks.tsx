...
export default function ShiftTasks() {
  ...
  return (
    ...
    >
      ...
      >
        <Clock size={20} style={{ color: "var(--color-primary)" }} /> Chấm công
        & Ca trực
      </h2>
        ...
        >
          <div
            ...
            style={{
              ...
              cursor: "pointer",
              boxShadow: checkedIn
                ? "0 0 20px var(--color-success-light)"
                : "0 0 20px var(--border-focus)",
              fontWeight: "bold",
      ...
      <div className="card">
        ...
        {dailyTurns.length === 0 ? (
          ...
          >
            {turnsLoading
              ? "Đang tải hàng đợi..."
              : "Không có thợ nào trong hàng đợi hôm nay."}
          </div>
        ) : (
            ...
            {dailyTurns.map((turn, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span
                      style={{ fontWeight, fontSize: "13px", color: textColor }}
                    >
                      {nameText}
                    </span>
                    <span
                    ...
                    >
                      {turn.role} • Walk-in: {turn.totalWalkinCount} • Tổng:{" "}
