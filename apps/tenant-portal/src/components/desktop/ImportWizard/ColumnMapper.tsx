...
export const ColumnMapper: React.FC<ColumnMapperProps> = ({
  ...
  const handleSelectHeaderForField = (field: string, newHeader: string) => {
    ...
    const currentHeader = Object.keys(mappings).find(
      (key) => mappings[key] === field,
    );
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      <div>
        ...
        <p style={{ color: "var(--text-secondary)", fontSize: "13px" }}>
          Hãy chọn cột tương ứng từ file của bạn. Nếu file Excel thiếu cột này,
          thiết lập giá trị mặc định ngay bên cạnh.
        </p>
      </div>
          ...
          <tbody>
            {targetSchema.map((target) => {
              ...
              const hasDefaultValue =
                defaultValues[target.field] !== undefined &&
                defaultValues[target.field] !== null &&
                String(defaultValues[target.field]).trim() !== "";
              const showRequiredWarning =
                isRequired && !mappedHeader && !hasDefaultValue;
              ...
              return (
                <tr
                  ...
                  style={{
                    ...
                    backgroundColor: showRequiredWarning
                      ? "hsl(0, 100%, 99%)"
                      : "white",
                  }}
                >
                  ...
                  <td style={{ padding: "10px 12px", verticalAlign: "middle" }}>
                    <select
                      ...
                      value={mappedHeader}
                      onChange={(e) =>
                        handleSelectHeaderForField(target.field, e.target.value)
                      }
                      style={{
                        padding: "4px 8px",
                        fontSize: "12.5px",
                      ...
                      >
                        ...
                        {target.type === "select" ? (
                          <select
                            ...
                            onChange={(e) =>
                              onDefaultValueChange(target.field, e.target.value)
                            }
                            style={{
                              padding: "4px 8px",
                              fontSize: "12.5px",
                          ...
                          <select
                            className="form-input"
                            value={
                              defaultValues[target.field] === true
                                ? "true"
                                : "false"
                            }
                            onChange={(e) =>
