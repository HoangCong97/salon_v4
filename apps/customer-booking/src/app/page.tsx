...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const branchesPromise = fetch(
      `${API_BASE}/branches?tenantId=${selectedTenant.id}`,
    )
      .then((res) => res.json())
      ...
      <div className="container">
        ...
        <div
          ...
          style={{
            marginBottom: "24px",
            background:
              "linear-gradient(135deg, rgba(245,158,11,0.03) 0%, rgba(18,26,47,0.4) 100%)",
          }}
        >
          <h3
            style={{
          ...
          >
            Chào mừng bạn đến với hệ thống Salon chuyên nghiệp hàng đầu. Chúng
            tôi cung cấp các dịch vụ cắt, tạo kiểu, uốn nhuộm và chăm sóc tóc
            chuyên sâu, cam kết đem lại trải nghiệm thư giãn đẳng cấp cùng diện
            mạo hoàn hảo.
          </p>
          <div style={{ display: "flex", gap: "16px", marginTop: "16px" }}>
            ...
            <div style={{ flex: 1, textAlign: "center" }}>
              ...
              >
                ...
                <path d="M11 3 8 9l3 13h2l3-13-3-6z"></path>
                <path d="M2 9h20"></path>
              </svg>
              <div
                style={{
        ...
        {selectedTenant && (
          <Link
            href={`/booking?tenantId=${selectedTenant.id}`}
            style={{
              textDecoration: "none",
              display: "block",
              marginBottom: "28px",
          ...
          {loading ? (
            ...
            filteredBranches.map((b) => (
              ...
              >
                ...
                >
                  <Link
                    href={`/booking?tenantId=${b.tenantId}&branchId=${b.id}`}
