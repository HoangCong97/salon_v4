...
const SettingsPage: React.FC = () => {
  ...
  const [smsConfig, setSmsConfig] = useState({
    provider: "Twilio",
    sid: "AC8a9b2d71f481a5c9d64b3",
    token: "••••••••••••••••••••",
    sender: "+1234567890",
  });
  const [emailConfig, setEmailConfig] = useState({
    provider: "SendGrid",
    apiKey: "SG.8c9b2f3a.7d81a9f1_e5",
    senderEmail: "no-reply@salonapp.com",
    senderName: "SALON SaaS Notification",
  });
  const [paymentConfig, setPaymentConfig] = useState({
    gateway: "VNPAY",
    tmnCode: "SALON001",
    hashSecret: "••••••••••••••••••••",
    redirectUrl: "https://api.salonapp.com/v1/payments/ipn",
  });
    ...
    >
      ...
      >
        ...
        <div style={{ fontSize: "13px", color: "var(--color-primary)" }}>
          <strong>Lưu ý bảo mật:</strong> Các thông tin API Keys, Client Secrets
          được mã hóa tự động ở cơ sở dữ liệu (AES-256). Mọi truy vấn thay đổi
          cấu hình đều được ghi nhận vào nhật ký hệ thống toàn cục.
        </div>
      </div>
      ...
      {saveStatus && (
        ...
        >
          ...
          >
            Cấu hình hệ thống toàn cục đã được lưu thành công!
          </span>
        </div>
      )}
      ...
      >
            ...
            >
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  value={smsConfig.sid}
                  onChange={(e) =>
                    setSmsConfig({ ...smsConfig, sid: e.target.value })
                  }
                />
              </div>
            </div>
            ...
            >
              <div className="form-group">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSmsConfig({ ...smsConfig, token: e.target.value })
                  }
                />
              </div>
              <div className="form-group">
                <label className="form-label">
                  Twilio Sender Number (SMS Brandname / Phone)
                </label>
                <input
                  type="text"
                  className="form-input"
                  ...
                  onChange={(e) =>
                    setSmsConfig({ ...smsConfig, sender: e.target.value })
                  }
                />
              </div>
            </div>
        ...
        {activeTab === "email" && (
          ...
          >
            ...
            >
              <div className="form-group">
                <label className="form-label">
                  Email Người gửi Mặc định (Sender Email)
                </label>
                <input
                  type="email"
                  className="form-input"
        ...
        {activeTab === "payment" && (
          ...
          >
            ...
            >
              Cổng Thanh Toán VNPAY IPN Integration
            </h4>
            ...
            >
              ...
              <div className="form-group">
                <label className="form-label">
                  IPN Callback URL (Đường dẫn webhook đồng bộ giao dịch)
                </label>
                <input
                  type="text"
                  className="form-input"
