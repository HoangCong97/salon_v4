...
async function seedSystemConfig() {
  console.log("🌱 Seeding System Configurations (Plans & Permissions)...");

  // 1. Seed SaaS Plans (Upsert based on code)
  ...
  const basicPlan = await prisma.saasPlan.upsert({
    ...
    update: {
      ...
      features: [
        ...
        "Quản lý ca kíp và tua làm thợ",
        "Hóa đơn & Bán hàng POS cơ bản",
        "SMS OTP thông báo",
      ],
    },
    create: {
  ...
  const premiumPlan = await prisma.saasPlan.upsert({
    where: { code: "PREMIUM" },
    update: {
      name: "Gói Premium",
      price: 799000,
      ...
      features: [
        ...
        "Cấu hình hoa hồng và lương thợ nâng cao",
        "Báo cáo chuyên sâu & biểu đồ phân tích",
        "Quản lý thẻ dịch vụ trả trước",
  ...
  // 2. Seed default permissions (Upsert/Find-and-Create to avoid duplicates)
  ...
  return { freePlan, basicPlan, premiumPlan, dbPermissions };
}

async function seedMockData(
  freePlan: { id: string },
  basicPlan: { id: string },
  premiumPlan: { id: string },
  dbPermissions: Array<{ id: string; slug: string }>,
) {
  console.log("🧹 Cleaning up old data before seeding mock data...");
  ...
  console.log("✨ Database cleaned for mock seeding!");

  // Re-seed system plans & permissions since they were deleted in cleanup
  console.log("🌱 Re-seeding base configs...");
  const base = await seedSystemConfig();
  const sysFreePlan = base.freePlan;
  const sysBasicPlan = base.basicPlan;
  const sysPremiumPlan = base.premiumPlan;
  const sysDbPermissions = base.dbPermissions;

  console.log("🌱 Seeding Mock Tenants...");
  ...
  const serviceData = [
    {
      ...
      priceCN2: 140000,
      priceCN3: 140000,
      additional: [110000, 130000, 190000, 210000, 220000, 160000, 140000],
      status: "Hoạt động",
    },
    {
      name: "COMBO Cao cấp",
      ...
      priceCN2: 210000,
      priceCN3: 210000,
      additional: [130000, 170000, 230000, 250000, 290000, 190000],
      status: "Hoạt động",
    },
    {
      ...
      priceCN2: 280000,
      priceCN3: 280000,
      additional: [290000, 350000, 360000, 260000, 250000, 240000],
      status: "Hoạt động",
    },
    {
      name: "COMBO 1",
...

    {
      name: "Hớt tóc",
      catId: catHair.id,
      serviceCategory: "Cơ bản",
      branches: ["CN2", "CN3"],
      priceCN2: 70000,
      priceCN3: 70000,
      additional: [60000, 70000, 80000],
      status: "Hoạt động",
    },
    {
      name: "Cạo mặt",
    ...
    },
    {
      ...
      priceCN2: 70000,
      priceCN3: 70000,
      additional: [30000, 50000, 60000, 70000],
      status: "Hoạt động",
    },
    {
    ...
    },
    {
      ...
      priceCN2: 80000,
      priceCN3: 80000,
      additional: [50000, 30000, 60000, 70000, 80000],
      status: "Hoạt động",
    },
    {
      name: "Đắp mặt nạ",
    ...
    {
      name: "Hút mụn + Xông mặt",
      catId: catHair.id,
      serviceCategory: "Cơ bản",
      branches: ["CN2", "CN3"],
      priceCN2: 130000,
      priceCN3: 130000,
      additional: [100000, 120000],
      status: "Hoạt động",
    },
    {
    ...
    },
    {
      ...
      priceCN2: 30000,
      priceCN3: 30000,
      additional: [10000, 20000, 30000],
      status: "Hoạt động",
    },
    {
      name: "Cắt tóc (Free thẻ tích điểm)",
      catId: catHair.id,
      serviceCategory: "Cơ bản",
      branches: ["CN2", "CN3"],
      priceCN2: 60000,
    ...
    {
      name: "Nhuộm đen",
      catId: catChemical.id,
      serviceCategory: "Hoá chất",
      branches: ["CN2", "CN3"],
      priceCN2: 300000,
      priceCN3: 300000,
      additional: [
    ...
    },
    {
      ...
      priceCN2: 500000,
      priceCN3: 500000,
      additional: [200000, 250000, 300000, 350000, 400000],
      status: "Hoạt động",
    },
    {
      name: "Tẩy tóc",
    ...
    },
    {
      ...
      priceCN2: 300000,
      priceCN3: 300000,
      additional: [200000, 250000, 300000, 350000, 380000, 400000],
      status: "Hoạt động",
    },
    {
      name: "Duỗi",
      ...
      priceCN2: 300000,
      priceCN3: 300000,
      additional: [200000, 250000, 300000, 350000, 400000, 450000, 500000],
      status: "Hoạt động",
    },
    {
      name: "Ép side",
...
async function main() {
  ...
  const shouldSeedMock =
    process.env.SEED_MOCK === "true" ||
    (isDev && process.env.SEED_MOCK !== "false");

  if (shouldSeedMock) {
    console.log(
      "🔹 Environment: DEVELOPMENT/TEST. Seeding system config and mock data...",
    );
    // Pass empty arrays/objects because they will be deleted & re-seeded inside seedMockData
    await seedMockData({ id: "" }, { id: "" }, { id: "" }, []);
  } else {
    console.log(
      "🔹 Environment: PRODUCTION/STAGING. Seeding system configurations ONLY...",
    );
